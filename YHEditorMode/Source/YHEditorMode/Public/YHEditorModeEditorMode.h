...
#include "YHEditorModeEditorMode.generated.h"
 ...
 */
UCLASS()
class UYHEditorModeEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_YHEditorModeEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;
	static FString YHToolName;

	UYHEditorModeEditorMode();
	virtual ~UYHEditorModeEditorMode();
